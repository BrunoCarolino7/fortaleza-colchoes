...
interface PedidoSeletorProps {
  pagamento?: Pagamento
  produtosSelecionados: ProdutoSelecionado[]
  onChange: (pagamento: Pagamento | undefined) => void
}

export function PagamentoSeletor({ pagamento, produtosSelecionados, onChange }: PedidoSeletorProps) {
  const calcularTotalProdutos = () =>
    produtosSelecionados.reduce((acc, produto) => acc + produto.preco, 0)
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        {!pagamento ? (<div className="text-center py-8 text-muted-foreground">
          Selecione um produto para receber informacoes de pagamento
        </div>
        ) : (
          <>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onChange({ ...pagamento, sinal: Number.parseFloat(e.target.value) })
                  }
                />
              </div>
              <div className="space-y-2">
                      ...
                      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5 items-end">
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            ...
                            onValueChange={(v) =>
                              updateParcela(i, { ...p, statusPagamento: Number(v) })
                            }
                          >
                            <SelectTrigger>
                              <SelectValue />
